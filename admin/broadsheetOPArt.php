...
<?php
  ...
  // $semester=htmlspecialchars($_POST['semester']);
   ...
   // $delete=mysqli_query($connection,"DELETE FROM courseregister WHERE faculty='".$_POST['faculty']."' AND dept='".$_POST['dept']."' AND level='".$_POST['level']."' AND session='".$_POST['session']."' ");    
                                             ...
                                             <th style="text-align:center; width:120px;">NAME</th>  
                                              <th style="padding:2.5px; width: 10%;" rowspan="3" colspan="3">Mathematics</th> 
                                                 <th style="padding:2.5px; width: 10%;" rowspan="3"  colspan="3">English Language</th> 
                                                  ...
                                                  <th style="padding:2.5px; width: 10%;" rowspan="3" colspan="3">Literature in English</th> 
                                                  ...
                                                  <th style="padding:2.5px; width: 10%;" rowspan="3" colspan="3">Civic Education</th> 
                                                   <th style="padding:2.5px; width: 10%;" rowspan="3" colspan="3">Government</th> 
                                                     <th style="padding:2.5px; width: 10%;" rowspan="3" colspan="3">Commerce</th>
...
?>
                                            ...
                                            <?php if($row['semestername']=='Mathematics')
                                             ...
                                             ?>
                                              ...
                                              <?php if($row['semestername']=='Literature in English')
                                               {
                                               ?> 
                                                <td style="text-align:center;"><?php echo caScore($ca= htmlentities($row['cascore']));?></td>  
                                                   <td style="text-align:center;"><?php echo exam($exam =htmlentities($row['examscore']));?></td>
                                                    <td style="text-align:center;"><?php echo  totalScores($lit=$exam + $ca); ?></td>
                                               <?php
                                               }
                                             ...
                                             ?> 
                                             <?php if($row['semestername']=='Commerce')
                                               {
                                               ?> 
                                                <td style="text-align:center;"><?php echo caScore($ca= htmlentities($row['cascore']));?></td>  
                                                   <td style="text-align:center;"><?php echo exam($exam =htmlentities($row['examscore']));?></td>
                                                    <td style="text-align:center;"><?php echo  totalScores($comm=$exam + $ca); ?></td>  
                                               <?php
                                               } 
                                             ?> 
                                             <?php if($row['semestername']=='Commerce')
                                               {
                                               ?> 
                                                   <td style="text-align:center;"><?php echo  $gtota = $maths +  $eng + $crs + $lit + $econs + $market + $yoruba + $bio + $geo + $comp + $civic + $gov + $comm; ?></td> 
                                             ...
                                             ?> 
                                              <?php if($row['semestername']=='Commerce')
                                               {
                                               ?>
                                                    <td style="text-align:center;"><?php $mksOble=100*13; echo  $average=round($gtota/$mksOble,4); ?></td> 
