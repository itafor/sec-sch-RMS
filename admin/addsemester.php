...
<?php include("includes/adminHead.php"); ?>
 <?php include("includes/adminMenu.php"); ?>
   ...
   <h4 class="page-head-line">Add New SEMESTER</h4>                    
      <?php 
...
<form action="addsemester.php" method="post" role="form" >
 <div class="controls">
...
//$connect = mysqli_connect('localhost', 'root', '', 'depotter');
 ...
 <div class="row">
  ...
  <div class="row">          
              <div class="col-md-6"> 
                    <div class="form-group">  
                         <label for="form_message">Available Semester</label> 
                             <select id="semester"  name="semester" multiple="multiple" class="form-control col-lg-12 col-md-12 col-sm-4 col-xs-12" disabled="disabled" style=" height:80px;" required="required">
        ...
        <div class="row">          
              <div class="col-md-8"> 
                  ...
                  <input id="addsemester" type="text" name="addsemester" class="form-control" placeholder="Please enter semester " required="required" data-error="Valid email is required.">              
                         </div>
                </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                <input type="submit" name="submit"  value="ADD Semester"  class="btn btn-success btn-send">
                    <div class="help-block with-errors"></div>
                </div>
            </div>
        </div>
