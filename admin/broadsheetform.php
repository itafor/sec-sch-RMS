...
<?php include("includes/adminHead.php"); ?>
 <?php include("includes/adminMenu.php"); ?>
   ...
   <h4 class="page-head-line">VIEW JSS BROADSHEET (JSS1-JSS3)</h4>                    
              
     
   <?php     
 $query =$connection->query("SELECT * FROM faculties where name='JSS1' OR name='JSS2'OR name='JSS3' "); 
 $rowCount=$query->num_rows;
 ?>  

     
<form action="broadsheetOP.php" method="post" class="regform" role="form" >
