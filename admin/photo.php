...
<?php include("includes/adminHead.php"); ?>
 ...
 <h4 class="page-head-line">CHANGE PROFILE PICTURE</h4> 
       ...
       if(isset($_POST['save_image']))
         {
           ...
           echo "<span style='color:red;font-family:arial;font-size:14pt;text-align:center;'>please choose a profile picture</span>";
            ...
            $dat = mysqli_query($connection,"UPDATE  admin set picture = '$file_path' WHERE username= '$username'") or die("eroor select ");
