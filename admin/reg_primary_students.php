...
<?php include("includes/adminHead.php"); ?>
 <?php include("includes/adminMenu.php"); ?>
   ...
   <h4 class="page-head-line">PRIMARY Subjects REGISTRATION FORM</h4>
    <h2> <a href="reg_new_pry_students.php">Register a student (new)</a></h2> </br></br>    
 <?php
  if(isset($_POST['submit'])){
    ...
    $sel_sci=mysqli_query($connection,"SELECT * FROM students where dept ='Primary' ");
   ...
   if(empty($year)){
    ...
    foreach($_POST['subject'] as $chkcourse){ 
           $sel=mysqli_query($connection,"SELECT * FROM  primary_register WHERE  subject='".$chkcourse."' AND dept='$dept' AND year='$year' AND term='$term' ");
       }
