...
<h4 class="page-head-line">Search Department</h4>
                                        ...
                                        <tr>
                                            <td><?php echo $sn;?></td>
                                             ...
                                             <td><?php echo htmlentities($row['name']);?></td>
                                                 <td>
                                            <a href="deletefaculty.php?id=<?php echo $row['id']?>" target="_blank" onclick="return confirm(' Are you sure you want to delete this dept? This action can not be undo')">
     ...
     ?>
      ...
      <form action="" method="POST" >
          <div class="row">
            <div class="col-md-7">
                <div class="form-group">
                   search dept by name:<span style="color:red">*</span>
                    <input id="form_name" type="text" name="faculty" class="form-control" placeholder="search dept" style=" height:70px; width: 700px;" value="<?php echo isset($_POST['student']) ? $_POST['student'] : '' ?>">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <input id="form_name" type="submit" name="search" value="SEARCH DEPT" class="btn btn-success btn-send" class="form-control" >
                    <div class="help-block with-errors"></div>
                </div>
            </div>
        </div>
