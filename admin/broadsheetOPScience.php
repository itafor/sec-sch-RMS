                                             ...
                                             <th style="text-align:center; width:120px;">NAME</th>  
                                              <th style="padding:2.5px; width: 10%;" rowspan="3" colspan="3">Mathematics</th> 
                                                 <th style="padding:2.5px; width: 10%;" rowspan="3"  colspan="3"> English language</th> 
                                                  <th style="padding:2.5px; width: 10%;" rowspan="3" colspan="3">Chemistry</th>
                                                  <th style="padding:2.5px; width: 10%;" rowspan="3" colspan="3">Physics</th> 
                                                   <th style="padding:2.5px; width: 10%;" rowspan="3" colspan="3">Biology</th> 
                                                     ...
                                                     <th style="padding:2.5px; width: 10%;" rowspan="3" colspan="3">Geography</th>
                                                  ...
                                                  <th style="padding:2.5px; width: 10%;" rowspan="3" colspan="3">Yoruba</th> 
                                                   <th style="padding:2.5px; width: 10%;" rowspan="3" colspan="3">Civic Education</th> 
                                                     ...
                                                     <th style="padding:2.5px; width: 10%;" rowspan="3" colspan="3">Technical Drawing</th>
...
?>
                                            ...
                                            <?php if($row['semestername']=='Mathematics')
                                             ...
                                             ?>
                                              <?php if($row['semestername']=='Chemistry')
                                               {
                                               ?> 
                                               <td style="text-align:center;"><?php echo caScore($ca= htmlentities($row['cascore']));?></td>  
                                                   <td style="text-align:center;"><?php echo exam($exam =htmlentities($row['examscore']));?></td>
                                                    <td style="text-align:center;"><?php echo  totalScores($chem=$exam + $ca); ?></td>
                                               <?php
                                               }
                                            
                                             ?>
                                             
                                              <?php if($row['semestername']=='Physics')
                                               {
                                               ?> 
                                                 <td style="text-align:center;"><?php echo caScore($ca= htmlentities($row['cascore']));?></td>  
                                                   <td style="text-align:center;"><?php echo exam($exam =htmlentities($row['examscore']));?></td>
                                                    <td style="text-align:center;"><?php echo  totalScores($phy=$exam + $ca); ?></td>
                                             ...
                                             ?>  
                                             <?php if($row['semestername']=='Geography')
                                               {
                                               ?> 
                                                <td style="text-align:center;"><?php echo caScore($ca= htmlentities($row['cascore']));?></td>  
                                                   <td style="text-align:center;"><?php echo exam($exam =htmlentities($row['examscore']));?></td>
                                                    <td style="text-align:center;"><?php echo  totalScores($geo=$exam + $ca); ?></td>    
                                               <?php
                                               } 
                                             ?> 
                                             ...
                                             ?>
                                              <?php if($row['semestername']=='Technical Drawing')
                                               {
                                               ?> 
                                                <td style="text-align:center;"><?php echo caScore($ca= htmlentities($row['cascore']));?></td>  
                                                   <td style="text-align:center;"><?php echo exam($exam =htmlentities($row['examscore']));?></td>
                                                    <td style="text-align:center;"><?php echo  totalScores($td=$exam + $ca); ?></td>
                                             ...
                                             <?php if($row['semestername']=='Technical Drawing')
                                               {
                                               ?> 
                                                   <td style="text-align:center;"><?php echo  $gtota = $maths +  $eng + $chem + $phy + $bio + $comp + $fmaths + $geo + $agric + $econs + $yoruba + $civic + $market + $td; ?></td> 
                                             ...
                                             ?> 
                                              <?php if($row['semestername']=='Technical Drawing')
                                               ...
                                               ?>
                                                    ...
                                                    <td style="text-align:center;"><?php $mksOble=100*14; $average=round($gtota/$mksOble,4); echo  $ave=round($gtota/$mksOble,4); ?></td> 
                                             ...
                                             <?php if($row['semestername']=='Technical Drawing')
                                               {
                                               ?>
                                                    <td style="text-align:center;"><?php echo $percentage =round($gtota/$mksOble * 100,2);  ?></td> 
