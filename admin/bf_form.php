...
<?php include("includes/connection.php"); ?>
 ...
 <?php include("includes/adminMenu.php"); ?> 
   ...
   <h4 class="page-head-line">get Brought Forward scores </h4>                    
              
     


     
<form action="bf_op.php" method="post" class="regform" role="form" >
 ...
 <div class="controls">
     <div class="row">
        ...
        <div class="form-group"> 
            <label for="form_message">select student</label>
         <select  name="regno"  class="form-control col-lg-12 col-md-12 col-sm-4 col-xs-12"">    <?php 
 ...
 $rowCount=$query->num_rows;
  ...
  while($row=$query->fetch_assoc()){ 
   echo '<option value= "'.$row['matricno'].'">'.$row['firstname'].'  '.$row['middlename'].'  Regno:'.$row['matricno'].'  </option>';
 }
   }else{
     echo '<option value="">Reg. no. not found </option>';
   }
 ?>
  </select> 
  </div>
