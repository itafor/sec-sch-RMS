...
<?php include("includes/adminHead.php"); ?>
 <?php include("includes/adminMenu.php"); ?>
   ...
   <?php 
    ...
    $delete=mysqli_query($connection,"DELETE FROM level WHERE id ='$courseID' ");
    if($delete)
    {
    echo "<div class='alert alert-success'>term removed successfully</div>";   
    }else{
        ...
        ?>  
                                    <tr>
                                            <td><?php echo $sn;?></td>
                                             ...
                                             <td><a href="removeterm.php?id=<?php echo $row['id']?>" onclick="return confirm('Are you sure you want to remove this term? You cant revert this action!')">
