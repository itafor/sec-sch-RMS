...
//***********************************************//
				...
				function isalphaWhitspace(ele)
                {
                    var r=/^\s{0,}\d+\.{0,1}\d+\s{0,}$/;
                    if(r.test(ele.value))
                     {
                         alert("This Field allows Only Alphabets and whitespaces.");
                         ele.value="";
                         ele.focus();
                     }
                }
                    ...
                    if(myform.subname.value=="" || myform.subdesc.value=="")
                     {
                         ...
                         myform.onSubmit=false;
				           ...
				           function validateStudentInfoform(details)
                {
                    var em=/[a-zA-Z0-9]+@[a-zA-Z0-9]+.[a-zA-Z]+/;
                    myform=document.forms[details];
                    if(myform.username.value=="" || myform.password.value=="" || myform.phone.value=="" || myform.name.value=="" || myform.subjcode.value=="" || myform.subject.value=="")
                     {
                         alert("Some of the fields are Empty.");
                         return false;
                         //  myform.onsubmit=false;
