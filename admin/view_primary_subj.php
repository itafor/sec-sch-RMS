...
<?php include("includes/adminHead.php"); ?>
 <?php include("includes/adminMenu.php"); ?>
   <h4 class="page-head-line">Primary School Subjects</h4> 
    
   
   <?php
   $sql = mysqli_query ($connection,"SELECT * FROM primary_subject ");
    if(mysqli_num_rows($sql)==0){
      echo "nothing found" ;
    } else{
       echo ' <div class="table-responsive">   
         <form method="post" action="primary_subj_delOP.php"> 
