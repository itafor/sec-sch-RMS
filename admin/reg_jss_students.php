...
<?php include("includes/adminHead.php"); ?>
 <?php include("includes/adminMenu.php"); ?>
   ...
   <h4 class="page-head-line">Jss Subjects REGISTRATION FORM</h4>
    <h2> <a href="reg_new_jss_students.php">Click to register a new student</a></h2> </br></br>    
 <?php
  if(isset($_POST['submit'])){
    ...
    $sel_sci=mysqli_query($connection,"SELECT * FROM students where dept ='JSS' ");
  ...
  if(mysqli_num_rows($sel) >= 1) {
   ...
   while($row=mysqli_fetch_array($sel_sci)){
    ...
    VALUES('','$fullname','$reg_no','$year','$class','$dept','$term','".mysqli_real_escape_string($connection, $sci_subj)."','00','00','00','00','$regdate')");
        ...
        if($query) {
            $success = "Subject(s) registered successfully";
          } else{
...
<div class="row">  
 ...
 $query =$connection->query("SELECT * FROM jss_subjs"); 
